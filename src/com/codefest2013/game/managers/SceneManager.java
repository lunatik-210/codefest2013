...
import com.codefest2013.game.scenes.ManagedLayer;
import com.codefest2013.game.scenes.ManagedScene;
...
public class SceneManager extends Object
{
	...
	private IUpdateHandler mLoadingScreenHandler = new IUpdateHandler() {
		...
		public void onUpdate(float pSecondsElapsed) {
			...
			if(mNumFramesPassed>2 && mNextScene.elapsedLoadingScreenTime>=mNextScene.minLoadingScreenTime) {
	...
	public void showScene(final ManagedScene pManagedScene) {
		...
		mEngine.getCamera().set(0f, 0f, ResourceManager.getInstance().CAMERA_WIDTH, ResourceManager.getInstance().CAMERA_HEIGHT);
		...
		if(pManagedScene.hasLoadingScreen) {
			...
			mEngine.setScene(pManagedScene.onLoadingScreenLoadAndShown());
